...
SLAP_TEMPLATES = (
    ...
    "{user1} തടിക്കഷണം കൊണ്ട് {user2} ന്റെ മോന്ത അടിച്ചു പൊളിച്ചു! ",
    "{user1} {user2} നെ കാലിൽ പിടിച്ചു കറക്കി തോട്ടിലേക്ക് എറിഞ്ഞു! ",
    "{user1} കറിക്കലം എടുത്ത് {user2} ന്റെ തലയിലേക്ക് ഇട്ടു!",
    "{user1} ഒരു ചൂലെടുത്ത് {user2} ന്റെ മുഖത്ത് ആഞ്ഞടിച്ചു!",
    "{user1} {user2} ന്റെ മൂട്ടിൽ പടക്കം ഇട്ട് പൊട്ടിച്ചു!",
    "{user1} ചൂരലെടുത്ത് {user2} ന്റെ ചന്തിക്ക് പൊട്ടിച്ചു!",
    "{user1} {user2} വിനെ കുനിച്ചു നിർത്തി കൂമ്പിനിടിച്ചു!",
    "{user1} ഒരു ഇരുമ്പിന്റെ കസേര എടുത്ത് {user2} ന്റെ കാലു രണ്ടും തല്ലിയൊടിച്ചു!",
    "{user1} {user2} നെ മരത്തിൽ കെട്ടിയിട്ട് മൂട്ടിൽ തീ കൊടുത്തു!"
    "{user1} {user2} ന്റെ കരണക്കുറ്റി അടിച്ചു പൊളിച്ചു!"
    "{user1} {user2} ന്റെ മൂട്ടിൽ പേനാ വെച്ചു കുത്തി!"
)
